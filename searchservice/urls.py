"""searchservice URL Configuration
...
from searchservice.settings import MEDIA_ROOT
...
urlpatterns = [
    ...
    path('reset_password_sent/', auth_views.PasswordResetDoneView.as_view(template_name="users/reset_password_send.html"),
