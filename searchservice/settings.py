"""
Django settings for searchservice project.
...
SECRET_KEY = 'django-insecure-4dzholq(trphgej&l)d1lqu_akyqy6ps+m@s0nu5hg0085*6u1'
...

    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'service.context_processors.wilaya',
